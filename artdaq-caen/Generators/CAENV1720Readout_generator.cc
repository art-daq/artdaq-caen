...
artdaqcaen::CAENV1720Readout::CAENV1720Readout(fhicl::ParameterSet const& ps)
...
void artdaqcaen::CAENV1720Readout::configureInterrupts(unsigned int iboard)
{
	uint32_t fBoardID = iboard;
	...
	retcode = artdaqcaen::CAENV1720Readout::WriteRegisterBitmask(fHandle[fBoardID], addr, data, bitmask);
...
void artdaqcaen::CAENV1720Readout::loadConfiguration(fhicl::ParameterSet const& ps)
{
...
void artdaqcaen::CAENV1720Readout::ConfigureDaisyChain(uint32_t iboard)
{
	uint32_t            fBoardID = iboard;
	CAEN_DGTZ_ErrorCode retcode;
	uint32_t            readback;
...
void artdaqcaen::CAENV1720Readout::ConfigureSelfTriggerMode(uint32_t iboard)
{
	uint32_t            fBoardID = iboard;
	CAEN_DGTZ_ErrorCode retcod   = CAEN_DGTZ_Success;
...
void artdaqcaen::CAENV1720Readout::ConfigureRecordFormat(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
artdaqcaen::CAENV1720Readout::~CAENV1720Readout()
{
	TLOG_ARB(TCONFIG, TRACE_NAME) << "~CAENV1720Readout()" << TLOG_ENDL;
...
void artdaqcaen::CAENV1720Readout::ConfigureDataBuffer(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720Readout::ConfigureTrigger(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720Readout::ConfigureReadout(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720Readout::ConfigureAcquisition(unsigned int iboard)
{
	uint32_t fBoardID = iboard;
...
bool artdaqcaen::CAENV1720Readout::WaitForTrigger(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720Readout::start()
{
	if(fVerbosity > 0)
...
void artdaqcaen::CAENV1720Readout::stop()
{
	if(fVerbosity > 0)
...
bool artdaqcaen::CAENV1720Readout::checkHWStatus_()
{
	for(unsigned int iboard = 0; iboard < fNBoards; iboard++)
	{
		uint32_t fBoardID = iboard;
...
bool artdaqcaen::CAENV1720Readout::GetData()
{
...
bool artdaqcaen::CAENV1720Readout::readWindowDataBlocksFromBoard(unsigned int iboard)
{
	uint32_t fBoardID = iboard;
...
bool artdaqcaen::CAENV1720Readout::readWindowDataBlocks()
{
	if(fail_GetNext)
	{
...
bool artdaqcaen::CAENV1720Readout::readSingleWindowDataBlock()
{
...
bool artdaqcaen::CAENV1720Readout::getNext_(artdaq::FragmentPtrs& fragments)
{
...
bool artdaqcaen::CAENV1720Readout::readSingleWindowFragments(artdaq::FragmentPtrs& fragments)
{
...
bool artdaqcaen::CAENV1720Readout::readCombinedWindowFragments(artdaq::FragmentPtrs&)
{
	throw std::runtime_error("Implement me correctly!");
}

void artdaqcaen::CAENV1720Readout::CheckReadback(
...
DEFINE_ARTDAQ_COMMANDABLE_GENERATOR(artdaqcaen::CAENV1720Readout)
