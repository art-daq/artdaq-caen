  ...
  fAcqMode(CAEN_DGTZ_SW_CONTROLLED)
{
  ...
  TLOG(TDEBUG)  << " Calling CAEN_DGTZ_OpenDigitizer(" <<CAEN_DGTZ_OpticalLink<<", "<<fCAEN.link<<", "<<fBoardChainNumber<<", "<< 0<<" , "<<&fHandle<<")"; //AA: debug 
...
CAEN_DGTZ_ErrorCode artdaqcaen::CAENV1730Readout::WriteRegisterBitmask(int32_t handle, uint32_t address,
...
//    TLOG(21) << __func__ << ": b4 FragmentBytes";
    auto fragment_uptr=artdaq::Fragment::FragmentBytes(fragment_datasize_bytes,fEvCounter,fFragmentID,artdaqcaen::detail::FragmentType::CAENV1730,metadata);
...
void artdaqcaen::CAENV1730Readout::CheckReadback(std::string label,
					      int boardID,
					      uint32_t wrote,
					      uint32_t readback,
					      int channelID)
