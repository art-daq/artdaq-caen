...
artdaqcaen::CAENV1720SpillReadout::CAENV1720SpillReadout(fhicl::ParameterSet const& ps)
...
void artdaqcaen::CAENV1720SpillReadout::configureInterrupts(unsigned int iboard)
{
	...
	retcode = artdaqcaen::CAENV1720SpillReadout::WriteRegisterBitmask(fHandle[fBoardID], addr, data, bitmask);
...
void artdaqcaen::CAENV1720SpillReadout::loadConfiguration(fhicl::ParameterSet const& ps)
{
...
void artdaqcaen::CAENV1720SpillReadout::ConfigureDaisyChain(uint32_t iboard)
{
	uint32_t            fBoardID = iboard;
	CAEN_DGTZ_ErrorCode retcode;
	uint32_t            readback;
	...
	if(fBoardID == 0)
	{
		...
		artdaqcaen::CAENDecoder::checkError(retcode, "SetFirstBoard", fBoardID);
	...
	else if(fBoardID == fNBoards - 1)
	{
		...
		artdaqcaen::CAENDecoder::checkError(retcode, "SetLastBoard", fBoardID);
		// retcode = CAEN_DGTZ_WriteRegister(fHandle[fBoardID], MCST_CONTROL, 0xaa);
		retcode = CAEN_DGTZ_ReadRegister(fHandle[fBoardID], MCST_CONTROL, &readback);
	...
	else
	{
		...
		artdaqcaen::CAENDecoder::checkError(retcode, "SetIntBoard", fBoardID);
		retcode = CAEN_DGTZ_ReadRegister(fHandle[fBoardID], MCST_CONTROL, &readback);
		TLOG(TLVL_INFO) << "Set Int Board Reg:0x" << std::hex << MCST_CONTROL << "=0x" << readback;
	}
}

void artdaqcaen::CAENV1720SpillReadout::ConfigureSelfTriggerMode(uint32_t iboard)
{
	uint32_t            fBoardID = iboard;
	CAEN_DGTZ_ErrorCode retcod   = CAEN_DGTZ_Success;
...
void artdaqcaen::CAENV1720SpillReadout::ConfigureRecordFormat(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
artdaqcaen::CAENV1720SpillReadout::~CAENV1720SpillReadout()
{
	TLOG_ARB(TCONFIG, TRACE_NAME) << "~CAENV1720SpillReadout()" << TLOG_ENDL;
...
void artdaqcaen::CAENV1720SpillReadout::ConfigureDataBuffer(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720SpillReadout::ConfigureTrigger(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720SpillReadout::ConfigureReadout(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720SpillReadout::ConfigureAcquisition(unsigned int iboard)
{
	uint32_t fBoardID = iboard;
...
bool artdaqcaen::CAENV1720SpillReadout::WaitForTrigger(uint32_t iboard)
{
	uint32_t fBoardID = iboard;
...
void artdaqcaen::CAENV1720SpillReadout::start()
{
	if(fVerbosity > 0)
...
void artdaqcaen::CAENV1720SpillReadout::stop()
{
	if(fVerbosity > 0)
...
bool artdaqcaen::CAENV1720SpillReadout::checkHWStatus_()
{
	for(unsigned int iboard = 0; iboard < fNBoards; iboard++)
	{
		uint32_t fBoardID = iboard;
...
bool artdaqcaen::CAENV1720SpillReadout::GetData()
{
...
bool artdaqcaen::CAENV1720SpillReadout::readWindowDataBlocksFromBoard(unsigned int iboard)
{
	uint32_t fBoardID = iboard;
...
bool artdaqcaen::CAENV1720SpillReadout::readWindowDataBlocks()
{
	if(fail_GetNext)
	{
...
bool artdaqcaen::CAENV1720SpillReadout::readSingleWindowDataBlock()
{
...
bool artdaqcaen::CAENV1720SpillReadout::getNext_(artdaq::FragmentPtrs& fragments)
{
...
bool artdaqcaen::CAENV1720SpillReadout::readSingleWindowFragments(artdaq::FragmentPtrs& fragments)
{
...
bool artdaqcaen::CAENV1720SpillReadout::readCombinedWindowFragments(artdaq::FragmentPtrs&)
{
	throw std::runtime_error("Implement me correctly!");
}

void artdaqcaen::CAENV1720SpillReadout::CheckReadback(
...
DEFINE_ARTDAQ_COMMANDABLE_GENERATOR(artdaqcaen::CAENV1720SpillReadout)
